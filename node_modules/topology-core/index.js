...
var Topology = /** @class */ (function () {
    function Topology(parent, options) {
        ...
        this.onMouseMove = function (e) {
            ...
            if ((e.ctrlKey || e.altKey) && _this.mouseDown) {
            ...
            requestAnimationFrame(function () {
                ...
                switch (_this.moveIn.type) {
                    ...
                    case MoveInType.ResizeCP:
                        _this.activeLayer.resizeNodes(_this.moveIn.activeAnchorIndex, pos);
                        _this.animateLayer.start(true);
                        if (_this.options.on) {
        ...
        this.ondblclick = function (e) {
            switch (_this.moveIn.type) {
                case MoveInType.Nodes:
                    if (_this.moveIn.hoverNode) {
                        var textObj = _this.clickText(_this.moveIn.hoverNode, new point_1.Point(e.offsetX, e.offsetY));
                        if (textObj) {
                            _this.showInput(textObj.node, textObj.textRect);
                        }
                        if (_this.options.on) {
                            _this.options.on('dblclick', _this.moveIn.hoverNode);
                        }
                    }
                    break;
            }
    ...
    Topology.prototype.clickText = function (node, pos) {
        ...
        for (var _i = 0, _a = node.children; _i < _a.length; _i++) {
            var item = _a[_i];
            var rect = this.clickText(item, pos);
            if (rect) {
                return rect;
            }
        }
    ...
    Topology.prototype.showInput = function (node, textRect) {
    ...
    Topology.prototype.translate = function (x, y, process) {
        ...
        for (var _b = 0, _c = this.data.lines; _b < _c.length; _b++) {
            ...
            le5le_store_1.Store.set('pts-' + item.id, null);
        }
